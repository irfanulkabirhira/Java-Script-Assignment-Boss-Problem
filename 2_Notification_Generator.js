...
conditin are :
==================
Mail : erfanulkabir12@gmail.com
=> User Name ==> erfanulkabir12
=> Income ==> gmail.com
=> Income and Exspence Never be (-ve)

Condition:
============
=> email should be ==> string  || in Emial must included @
After Spliting the *UserName and *Domain name
=> @ must be contain one time in a email address not more than this
=> user name and Domain Name => Empty or not
